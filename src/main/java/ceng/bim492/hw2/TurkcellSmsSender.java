 ...
 * Time: 4:47 PM
 */
@com.codometer.homework.bim460.homework3.annotations.TurkcellSmsSender
public class TurkcellSmsSender extends SmsSender {


    @PrepareSms
    public void PrepareSms() {
        getSms().addStatus(SmsStatus.TurkcellPrepared);

    }

    @SendSms
    public void SendSms() {
        getSms().addStatus(SmsStatus.TurkcellSent);
    }

    @ProcessResult
    public void ProcessResult() {
        getSms().addStatus(SmsStatus.TurkcellProcessed);
    }
}
